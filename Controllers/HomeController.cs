...
using listaDeTarefasWeb.Models;
using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;
using System.Diagnostics;

namespace listaDeTarefasWeb.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Index(string id)
        {
            ...
            var filtros = new Filtros(id ?? string.Empty);

            ViewBag.Filtros = filtros;
            ViewBag.CategoriaId = _context.Categorias.ToList();
        ...
        [HttpPost]
        public IActionResult MarcarCompleto([FromRoute] string id, Tarefa tarefasSelecionada)
        {
            tarefasSelecionada = _context.Tarefas.Find(tarefasSelecionada.Id);
            if (tarefasSelecionada != null)
            {
                tarefasSelecionada.StatusId = "completo";
